...
In folder test-network run "./network.sh up"

# Start channel for network

In folder test-network run "./network.sh createChannel"

# Add Org3 and Org4 to network and join to channel

In folder repsectedly AddOrg3, AddOrg4 run "./addOrg3 up" and "./addOrg4 up"
